...
train.config['nwpernode'] = args.nwpernode
...
if args.task == 'resnet18':
    ...
    #############################################
    ############## ResNet152-CIFAR10 ##########
if args.task == 'resnet152':
    train.config['task']= "Cifar"
    train.config['task_architecture']= "ResNet152"
    #############################################
    ############## VGG19-CIFAR10 ##########
elif args.task == 'vgg19':
    train.config['task']= "Cifar"
    train.config['task_architecture']= "vgg19_bn"
    #############################################
    ############## SENet-CIFAR10 ##########
    ...
    train.config['task_architecture']= "googlenet"
    #############################################
    ############## Inceptionv4-CIFAR100 ##########
elif args.task == 'inceptionv4_cifar100':
    train.config['task']= "Cifar100"
    train.config['task_architecture']= "inceptionv4"
    #############################################
    ################ WikiText2###################
...
if args.reducer=='exact':
    ...
    ############################
elif args.reducer=='exdyna':
    ############# ExDyna ############
    train.config['optimizer_reducer'] = "ExDynaReducer"
    train.config['optimizer_reducer_compression'] = args.comp_ratio
    train.config['optimizer_memory'] = not args.no_memory
    train.config['run_name'] = 'exdyna' + '_' + str(train.config['optimizer_reducer_compression']) + '_mem' + str(train.config['optimizer_memory'])+'_'+str(train.config['seed'])
    #############################
elif args.reducer=='micro':
    ############# Micro ############
    train.config['optimizer_reducer'] = "MicroReducer"
    train.config['optimizer_reducer_compression'] = args.comp_ratio
    train.config['optimizer_memory'] = not args.no_memory
    train.config['run_name'] = 'micro' + '_' + str(train.config['optimizer_reducer_compression']) + '_mem' + str(train.config['optimizer_memory'])+'_'+str(train.config['seed'])
    #############################
elif args.reducer=='deft':
    ############# DEFT ############
    train.config['optimizer_reducer'] = "DeftReducer"
    train.config['optimizer_reducer_compression'] = args.comp_ratio
    train.config['optimizer_memory'] = not args.no_memory
    train.config['run_name'] = 'deft' + '_' + str(train.config['optimizer_reducer_compression']) + '_mem' + str(train.config['optimizer_memory'])+'_'+str(train.config['seed'])
    #############################
    ...
    ############# CLTk ############
    train.config['optimizer_reducer'] = "CLTKReducer"
    train.config['optimizer_reducer_compression'] = args.comp_ratio
    train.config['optimizer_memory'] = not args.no_memory
    train.config['run_name'] = 'cltk' + '_' + str(train.config['optimizer_reducer_compression']) + '_mem' + str(train.config['optimizer_memory'])+'_'+str(train.config['seed'])
    #############################
